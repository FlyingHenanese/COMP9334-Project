...
if __name__ == '__main__':
    ...
    #manually change number in sim_start to simulate the different time sequence
    # sim_start(300000)
    #draw diagram
    #manually change value in start to change n and simulation time
    Final_list = []
